...
<section style="padding: 40px 0; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); min-height: 100vh;">
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-light px-3 py-2 rounded">
                ...
                <li class="breadcrumb-item active text-blue fw-semibold">
                    <i class="fas fa-map-marker-alt me-1"></i>Lokasi Proyek
                </li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-1 text-dark fw-bold">Data Lokasi Proyek</h2>
                <p class="text-muted mb-0">Lihat lokasi dan koordinat geografis proyek</p>
            </div>
            <div class="d-flex gap-2 align-items-center">
                <span class="badge bg-blue fs-6 px-3 py-2">
                    <i class="fas fa-map-marked-alt me-1"></i>
                    {{ $lokasi->count() }} Total Lokasi
                </span>
            </div>
        </div>
                        ...
                        <div class="card-header" style="background: linear-gradient(135deg, #3b82f6 0%, #60a5fa 100%); color: white; padding: 20px; border: none;">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-white-50">Lokasi Proyek</small>
                                </div>
                                <span class="badge bg-white text-blue ms-2">#{{ $item->lokasi_id }}</span>
                            </div>
                        </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="row g-3 mb-3">
                                <div class="col-12">
                                    ...
                                    @if($item->proyek && $item->proyek->kode_proyek)
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-6">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <small class="text-muted fw-semibold">LATITUDE</small>
                                    </div>
                                    <code class="bg-light p-2 rounded d-block text-center">{{ $item->lat }}</code>
                                </div>
                                <div class="col-6">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="fas fa-globe text-warning me-2"></i>
                                        <small class="text-muted fw-semibold">LONGITUDE</small>
                                    </div>
                                    <code class="bg-light p-2 rounded d-block text-center">{{ $item->lng }}</code>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <small class="text-muted fw-semibold">GEOJSON</small>
                                    </div>
                                    @if($item->geojson)
                            ...
                            @if($item->proyek && $item->proyek->lokasi)
                                <div class="row g-3 mb-3">
                                    <div class="col-12">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="fas fa-map-marker-alt text-danger me-2"></i>
                                            <small class="text-muted fw-semibold">ALAMAT PROYEK</small>
                                        </div>
                                        <p class="mb-0 text-muted small">{{ Str::limit($item->proyek->lokasi, 80) }}</p>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="mt-auto">
                                <div class="bg-light p-3 rounded">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <i class="fas fa-crosshairs text-blue me-2"></i>
                                        <small class="text-muted fw-semibold">KOORDINAT</small>
                                    </div>
                                    <div class="text-center mt-2">
                                        <strong class="text-blue">{{ $item->lat }}, {{ $item->lng }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer bg-light border-top-0 mt-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a href="https://www.google.com/maps?q={{ $item->lat }},{{ $item->lng }}" 
                                   target="_blank" class="btn btn-outline-success btn-sm" title="Buka di Google Maps">
            ...
            @empty
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted">Tidak ada data lokasi proyek</h5>
                        <p class="text-muted">Belum ada data lokasi untuk ditampilkan.</p>
                    </div>
                </div>
            @endforelse
        </div>
