    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-30">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Tahapan</li>
            </ol>
        </nav>

        <!-- Header -->
        <div class="mb-30">
            <h2 class="mb-10">Tambah Tahapan Proyek</h2>
            <p style="color: #718096;">Buat tahapan baru untuk proyek pembangunan</p>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control @error('proyek_id') is-invalid @enderror"
                                ...
                                @foreach(\App\Models\Proyek::all() as $proyek)
                                    <option value="{{ $proyek->proyek_id }}"
                                        {{ old('proyek_id', request('proyek_id')) == $proyek->proyek_id ? 'selected' : '' }}>
                                        {{ $proyek->nama_proyek }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('nama_tahap') is-invalid @enderror"
                                ...
                                placeholder="Contoh: Tahapan Persiapan" required>
                            @error('nama_tahap')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12" style="border-top: 1px solid #E2E8F0; padding-top: 20px;">
                            <div class="d-flex gap-2">
                                <button type="submit" class="button button-primary">
                                    <i class="fas fa-save me-2"></i> Simpan Tahapan
                                </button>
